...
| Week 14 | 열적 특성 — 냉각 시뮬레이션과 에너지 공학 | [`ko/week14/`](ko/week14/) |
...
| Week 11 | Optical Properties & Color Engineering — Automatic Sorting | [`en/week11/`](en/week11/) |
...
| Week 14 | Thermal Properties — Cooling Simulation and Energy Engineering | [`en/week14/`](en/week14/) |
...
│   ├── week12/        ← [12주차] 광학적 특성 II - 분광 분석 (Optical Properties II - Spectroscopy)
│   ├── week13/        ← [13주차] 음향 특성 - 경도 분석 (Acoustic Properties - Firmness Analysis)
│   ├── week14/        ← [14주차] 열적 특성 - 냉각 시뮬레이션 (Thermal Properties - Cooling Simulation)
...
│   ├── week12/        ← [Week 12] Optical Properties II — Spectroscopy
│   ├── week13/        ← [Week 13] Acoustic Properties — FFT-Based Firmness Analysis
