...
Analysis of correlation between resonance frequency from impact excitation and fruit firmness using FFT.
- **Key Learning Scripts**:
  - `step1_acoustic_fft.py`: FFT transformation of time-domain impact response signals, resonance peak extraction, and mass-corrected firmness index modeling.
- ➡️ **[View Detailed Lab Tutorial for This Week](week13/Week13_Lab_Acoustic_Firmness.md)**

### [Week 14] Thermal Properties — Cooling Simulation and Energy Engineering
Simulation of cooling curves based on partial differential equations using SciPy's solve_ivp to understand the thermal properties of biomaterials.
- **Key Learning Scripts**:
  - `step1_cooling_simulation.py`: 1D Spherical heat conduction PDE simulation, calculation of half-cooling time and Biot Number.
- ➡️ **[View Detailed Lab Tutorial for This Week](week14/Week14_Lab_Thermal_Cooling.md)**
...
- **Weekly Update Log**: 
  ...
  - `[Week 11]` Implemented machine vision-based automated color sorting mechanism.
  - `[Week 12]` Performed NIR spectroscopy data preprocessing and PLSR modeling for Brix prediction.
  - `[Week 13]` Developed FFT-based acoustic firmness analysis script.
  - `[Week 14]` Simulated 1D spherical heat conduction for cooling process analysis.
